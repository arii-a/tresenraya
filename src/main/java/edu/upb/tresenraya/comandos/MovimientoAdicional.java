...
@Getter
@Setter
public class MovimientoAdicional extends Comando {
    private String simboloJuego;
    private int posX;
    private int posY;
    
    public MovimientoAdicional(String simboloJuego, int posX, int posY){
        super();
    ...
    public void parsear(String message) throws Exception {
        ...
        } if(comando.length() != 4 || !comando.equals("0011")) {
